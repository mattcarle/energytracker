...
@Entity
@Table(name = "UNIT_RATE_BY_HALF_HOUR", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"agreement_id", "valid_from", "payment_method", "rate_type"})
})
public class UnitRateByHalfHour {
    ...
    public UnitRateByHalfHour() {
        this.createdAt = LocalDateTime.now();
    }

    public UnitRateByHalfHour(Long agreementId, BigDecimal valueExcVat, BigDecimal valueIncVat, LocalDateTime validFrom, LocalDateTime validTo, String paymentMethod, String rateType) {
