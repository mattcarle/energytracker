...
@Entity
@Table(name = "STANDING_CHARGE_BY_DAY", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"agreement_id", "payment_method", "valid_from"})
})
public class StandingChargeByDay {
    ...
    public StandingChargeByDay() {
        this.createdAt = LocalDateTime.now();
    }

    public StandingChargeByDay(Long agreementId, BigDecimal valueExcVat, BigDecimal valueIncVat, LocalDateTime validFrom, LocalDateTime validTo, String paymentMethod) {
